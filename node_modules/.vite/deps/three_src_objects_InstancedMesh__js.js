...
var Ray = class {
  ...
  distanceSqToPoint(point) {
    ...
    _vector4.copy(this.direction).multiplyScalar(directionDistance).add(this.origin);
...
//# sourceMappingURL=three_src_objects_InstancedMesh__js.js.map
